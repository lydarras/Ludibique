 ...
 */
final class Version20230210084249 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE participation (id INT AUTO_INCREMENT NOT NULL, joueur_id INT DEFAULT NULL, seance_id INT DEFAULT NULL, INDEX IDX_AB55E24FA9E2D76C (joueur_id), INDEX IDX_AB55E24FE3797A94 (seance_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
